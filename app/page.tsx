...
export default function Home() {
  ...
  function download3mf() {
    try {
      ...
      const blob = multiPlate ? createMultiPlate3mf(parts, allPlacements, exportPlates) : create3mf(parts, allPlacements);
