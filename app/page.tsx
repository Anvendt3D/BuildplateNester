  ...
  return <main className="app-shell" aria-busy={isWorking}>
    ...
    <section className="workspace">
      ...
      <section className="plate-stage">
        ...
        <div className={`plate-wrap ${plates.length > 1 ? "multi-plate-source" : ""}`}><div className="plate-frame" style={{ aspectRatio: `${bedWidth}/${bedDepth}` }}><div className="dimension top"><span>{bedWidth} mm</span></div><div className="dimension side"><span>{bedDepth} mm</span></div>
